...
if check_password():
    ...
    fromdate = st.date_input('Input first data', value=datetime.today() - timedelta(days=14), min_value=datetime.date('2023-01-01'), max_value=datetime.today() - timedelta(days=13))
